...
public class ImagePopup extends ImageView {
    ...
    public void setCloseIcon(ImageView image) {
        Log.d("#CLS", String.valueOf(closeIcon));
        closeIcon.setImageDrawable(image.getDrawable());
    }
...
//
            ...
            closeIcon = (ImageView)layout.findViewById(R.id.closeBtn);
